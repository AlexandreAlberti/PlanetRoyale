...
namespace Opsive.BehaviorDesigner.AddOns.MovementPack.Runtime.Tasks
{
    ...
    public class NavMeshAgentPathfinder : Pathfinder
    {
        ...
        [SerializeField] protected SharedVariable<bool> m_UpdateRotation = false;
        ...
        {
            return m_NavMeshAgent.hasPath && m_NavMeshAgent.remainingDistance > m_NavMeshAgent.stoppingDistance;
        }
