...
namespace Opsive.BehaviorDesigner.AddOns.SensesPack.Runtime.Tasks
{
    ...
    [NodeDescription("A conditional task that checks if a GameObject-based sensor can detect any objects.  If the compare object is null then the task will return success if any object is returned.")]
