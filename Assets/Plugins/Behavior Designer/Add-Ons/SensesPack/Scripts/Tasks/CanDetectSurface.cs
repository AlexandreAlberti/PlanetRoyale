...
namespace Opsive.BehaviorDesigner.AddOns.SensesPack.Runtime.Tasks
{
    ...
    [NodeDescription("A conditional task that checks if a surface sensor can detect the specified surface. If the compare surface is null then the task will return success if any object is returned.")]
    ...
    public class CanDetectSurface : Conditional
    {
        ...
        /// </summary>
        protected override bool ReceiveDrawGizmosCallback => true;
