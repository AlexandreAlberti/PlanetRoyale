...
namespace Opsive.BehaviorDesigner.AddOns.SensesPack.Runtime.Tasks
{
    ...
    [NodeDescription("Allows an agent to follow a trail of traces, useful for scent-based or trail-based navigation. Requires the Movement Pack for Behavior Designer Pro.")]
