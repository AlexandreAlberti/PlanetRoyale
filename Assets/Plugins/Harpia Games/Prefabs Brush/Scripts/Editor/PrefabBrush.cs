...
namespace Harpia.PrefabBrush
{
    public class PrefabBrush : EditorWindow
    {
        ...
        {
            UnityEngine.Application.OpenURL("https://harpiagames.gitbook.io/prefab-brush-documentation/");
        }

        [MenuItem("Tools/Prefab Brush/Rate This asset", false, 12)]
        private static void OpenRatePage()
        {
            UnityEngine.Application.OpenURL("https://u3d.as/37hF");
        }

        [MenuItem("Tools/Prefab Brush/Discord", false, 11)]
        private static void OpenOpenDiscord()
        {
            UnityEngine.Application.OpenURL("https://discord.gg/Tr952uhsqb");
        }

        [MenuItem("Tools/Prefab Brush/More Tools/Low Poly Color Changer", false, 12)]
        private static void ToolsLowPoly()
        {
            UnityEngine.Application.OpenURL("https://assetstore.unity.com/packages/tools/level-design/low-poly-color-changer-easy-color-changing-variations-248562?aid=1100lACye");
        }

        [MenuItem("Tools/Prefab Brush/More Tools/Prefab Icons - Icon Creator", false, 12)]
        private static void ToolsIconCreator()
        {
            UnityEngine.Application.OpenURL("https://assetstore.unity.com/packages/tools/game-toolkits/icon-creator-generate-fast-easy-complete-icons-generator-198488?aid=1100lACye&utm_campaign=unity_affiliate&utm_medium=affiliate&utm_source=partnerize-linkmaker");
        }
...
#endif
            return path.Contains(UnityEngine.Application.dataPath);
        }
...
#endif
            UnityEngine.Application.OpenURL("https://docs.unity3d.com/ScriptReference/KeyCode.html");
        }
