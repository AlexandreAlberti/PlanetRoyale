...
{
    public class ProjectilePlayerDamageArea : ProjectileDamageArea
    {
        [SerializeField] protected PlayerDamageArea _damageAreaPrefab;
        ...
        protected override void SpawnDamageArea()
        {
            ...
            PlayerDamageArea playerDamageArea = damageAreaInstance.GetComponent<PlayerDamageArea>();
            playerDamageArea.Initialize(_damage);
        }
