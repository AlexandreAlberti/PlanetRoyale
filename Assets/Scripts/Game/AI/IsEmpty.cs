...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Conditionals
{
    ...
    [NodeDescription("Returns true if the specified variable has not a value.")]
    public class IsEmpty : Conditional
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (m_Variable == null || (variableValue = m_Variable.GetValue()) == null) {
                return TaskStatus.Success;
            }

            if (variableValue is IList listValue) {
                return listValue.Count > 0 ? TaskStatus.Failure : TaskStatus.Success;
            }
